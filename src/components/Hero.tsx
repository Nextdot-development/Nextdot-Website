  ...
  return (
    <section className="pt-32 md:pt-40 pb-20 md:pb-32 relative overflow-hidden bg-paper">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative mt-32 md:mt-48 -mx-6 px-6 py-20 md:py-32 bg-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-medium text-ink mb-6 leading-tight">
              ...
              <div className="space-y-5">
                {[
                  ...
                  >
                    {/* Light glass card */}
                    <div className="relative p-6 rounded-2xl border border-line/50 bg-white/60 backdrop-blur-sm hover:bg-white/80 hover:border-blue-200/60 transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-blue-500/5 overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <motion.div
                          ...
                          className="text-4xl sm:text-5xl font-display font-medium text-blue-600 mb-3 group-hover:text-blue-700 transition-all duration-300"
                        >
                          {item.num}
                        </motion.div>

                        {/* Title */}
                        <h3 className="text-lg sm:text-xl font-medium text-ink mb-2 group-hover:text-blue-600 transition-colors duration-300">
                          {item.title}
                        </h3>
